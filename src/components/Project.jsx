    ...
    return (
      <div id='projects' className="project">
        ...
        <section className='mx-auto max-w-[48rem]'>
          ...
          <div>
              <a href="https://agungshndy.github.io/currency-app/" target='_blank' className="group relative block overflow-hidden">
                <button className="absolute end-4 top-4 z-10 rounded-full bg-white p-1.5 text-gray-900 transition hover:text-gray-900/75">
                  <span className="sr-only">Wishlist</span>
                ...
                <div className="relative border border-gray-100 bg-white p-6">
                  ...
                  <p className="mt-1.5 mb-3 line-clamp-3 text-gray-700">
                    Web App Project, create a real-time currency update.
                  </p>
          ...
          <div>
              <a href="https://agungshndy.github.io/kanban-board/" target='_blank' className="group relative block overflow-hidden">
                ...
                <div className="relative border border-gray-100 bg-white p-6">
                  ...
                  <p className="mt-1.5 mb-3 line-clamp-3 text-gray-700">
                    Kanban Board Web App that can help you manage the project.
                  </p>
          ...
          <div>
              <a href="https://agungshndy.github.io/finance-tracker/" target='_blank' className="group relative block overflow-hidden">
                ...
                <div className="relative border border-gray-100 bg-white p-6">
                  ...
                  <p className="mt-1.5 mb-3 line-clamp-3 text-gray-700">
                    Finance Tracker Web App with AI-powered to help you manage your money.
                  </p>
